Krazor is the underlying cryptocurrency used in the [Blockrazor](https://github.com/Blockrazor/blockrazor) project.
...
Report any vulnerabilities to gareth.hayes AT gmail.com.

In addition, any vulnerabilities probably also apply to Monero so you should use their reporting channels:
...
- Monero developers are also available via [HackerOne](https://hackerone.com/monero)
